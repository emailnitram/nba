...
/***/ function(module, exports, __webpack_require__) {
	...
	var HighLight = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'video',
	        { preload: 'none', controls: true, poster: "https://cdn.streamable.com/image/" + this.props.h.shortCode + ".jpg", width: '100%' },
	        React.createElement('source', { src: "https://cdn.streamable.com/video/mp4-mobile/" + this.props.h.shortCode + ".mp4" })
	      ),
	      React.createElement(
	        'h1',
	        null,
	...
	function filterStreamableLinks(allHighlights) {
	  return allHighlights.filter(function (item) {
	    return (/streamable/.test(item.data.url)
	    );
	  });
	}
	...
	var UserGist = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    fetch(this.props.source).then(function (response) {
	      ...
	      var streamableLinks = filterStreamableLinks(result.data.children);
	      if (this.isMounted()) {
	        this.setState({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      this.state.highlights.map(function (h, i) {
	        return React.createElement(HighLight, { key: i, h: h });
	      })
	    );
	  }
	});

	ReactDOM.render(React.createElement(UserGist, { source: 'https://www.reddit.com/r/nba/top.json' }), document.getElementById('nba'));
